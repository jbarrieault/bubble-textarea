...
// CalculateContentHeight calculates the total height needed to display all content
// taking into account both hard line breaks (newlines) and soft line breaks (wrapping).
